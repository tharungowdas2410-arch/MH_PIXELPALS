...
import { Loader2, AlertTriangle, Image as ImageIcon, Video as VideoIcon, Mic as MicIcon, RefreshCw, ChevronDown, Sparkles, FileSearch, Shield } from 'lucide-react';
...
const UploadSection = ({
  ...
  const EmptyStateIllustration = () => (
    <div className="relative">
      ...
      <div className="relative">
        <div className="w-24 h-24 mx-auto overflow-hidden rounded-full bg-white dark:bg-neutral-800 shadow-lg ring-4 ring-primary-100 dark:ring-primary-900/30 flex items-center justify-center">
          <Shield className="h-14 w-14 text-primary-500 dark:text-primary-400" />
        </div>
