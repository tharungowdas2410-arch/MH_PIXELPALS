...
import { 
  ...
  Copy, Shield, Activity, FileJson, FileText, AlertCircle as AlertCircleIcon, 
  ChevronUp, PieChart as PieChartIcon, TrendingUp, Brain, Zap
} from 'lucide-react';
import { 
  formatProbability, 
      ...
      <div className="px-6 py-4 bg-gradient-to-r from-neutral-50 to-neutral-100 dark:from-neutral-800 dark:to-neutral-700 border-b border-neutral-200 dark:border-neutral-700">
        <div className="flex flex-wrap gap-2 items-center justify-between">
          <div className="flex items-center">
            <div className="overflow-hidden rounded-full mr-2 p-1 bg-white dark:bg-neutral-700">
